<x-app-layout :pagename="__('locale.profile')">    
    <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
        <div class="mt-1 mx-auto rounded-none card">
                    ...
                    <div class="grid grid-cols-1 gap-5 lg:grid-cols-12 2xl:grid-cols-12">
                        <div class="lg:col-span-2 2xl:col-span-1">
                            <div class="relative inline-block rounded-full shadow-md size-20 bg-slate-100 profile-user xl:size-28">
                                <img src="{{ userphoto($user) }}" alt="PHOTO" class="object-cover border-0 rounded-full img-thumbnail user-profile-image">
                                <div class="absolute bottom-0 flex items-center justify-center rounded-full size-8 ltr:right-0 rtl:left-0 profile-photo-edit">
                                    <input id="profile-img-file-input" type="file" name="photo" class="hidden profile-img-file-input" accept=".jpeg, .png, .jpg, .gif, .svg, .webp">
                        ...
                        <div class="lg:col-span-10 2xl:col-span-9">
                            <h5 class="mb-1">{{ $user->name }} <i data-lucide="badge-check" class="inline-block size-4 text-sky-500 fill-sky-100 dark:fill-custom-500/20"></i></h5>
                            <div class="flex gap-3 mb-4">
                                <p class="text-slate-500 dark:text-zink-200"><i data-lucide="user-circle" class="inline-block size-4 ltr:mr-1 rtl:ml-1 text-slate-500 dark:text-zink-200 fill-slate-100 dark:fill-zink-500"></i> {{ $user->role }}</p>
                                <p class="text-slate-500 dark:text-zink-200"><i data-lucide="phone" class="inline-block size-4 ltr:mr-1 rtl:ml-1 text-slate-500 dark:text-zink-200 fill-slate-100 dark:fill-zink-500"></i> {{ $user->phone }}</p>
                            ...
                            <ul class="flex flex-wrap gap-3 mt-4 text-center divide-x divide-slate-200 dark:divide-zink-500 rtl:divide-x-reverse">
                                <li class="px-5">
                                    ...
                                    <div class="relative">
                                        ...
                                        <button type="button"
                                                class="toggle-password absolute top-3 ltr:right-3 rtl:left-3 text-slate-500 dark:text-zinc-200 focus:outline-none"
                                                data-target="password"
                                        >
                                        <svg class="eye-icon lucide lucide-eye size-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                            <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
                                            <circle cx="12" cy="12" r="3"></circle>
                                        </svg>
                                        <svg class="eye-off-icon lucide lucide-eye-off size-4 hidden" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                            <path d="M9.88 9.88a3 3 0 1 0 4.24 4.24"></path>
                                            <path d="M10.73 5.08A9.77 9.77 0 0 1 12 5c7 0 11 7 11 7a18.41 18.41 0 0 1-3.6 4.77"></path>
                                            <path d="M6.36 6.36A10.06 10.06 0 0 0 1 12s4 7 11 7a10.55 10.55 0 0 0 5.53-1.61"></path>
                                ...
                                <li class="px-5">
                                    <div>
                                        <div class="relative">
                                            ...
                                            class="ltr:pr-10 rtl:pl-10 form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                            placeholder="@lang('locale.password_confirmation')"
                                            required
                                            >
                                ...
                                <li class="px-5">
                                    <div class="flex gap-2 2xl:justify-end">
                                        <button class="text-white transition-all duration-200 ease-linear btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20">@lang('locale.update_profile')</button>
                                    </div>
                                </li>
                            </ul>
                        </div>
            ...
            <div class="block tab-pane" id="overviewTabs">
                <div class="grid grid-cols-1 gap-x-5 2xl:grid-cols-12">
                    <div class="2xl:col-span-3">
                        <div class="card">
                            <div class="card-body">
                                <h6 class="mb-4 text-15">@lang('locale.company_info')</h6>
                                <div class="overflow-x-auto">
                                    <table class="w-full ltr:text-left rtl:ext-right">
                                        <tbody>
                                            <tr>
                                                <th class="py-2 font-semibold ps-0" scope="row">Designation</th>
                                                <td class="py-2 text-right text-slate-500 dark:text-zink-200">CEO & Founder</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="py-2 text-right text-slate-500 dark:text-zink-200"><a href="http://themesdesign.in/" target="_blank" class="text-custom-500">www.themesdesign.in</a></td>
                                            </tr>
                                            <tr>
                                                <th class="py-2 font-semibold ps-0" scope="row">Email</th>
                                                <td class="py-2 text-right text-slate-500 dark:text-zink-200">paula@themesdesign.com</td>
                                            </tr>
                                            <tr>
                                                <th class="py-2 font-semibold ps-0" scope="row">Location</th>
                                                <td class="py-2 text-right text-slate-500 dark:text-zink-200">Los Angeles, California</td>
                                            </tr>
                                            <tr>
                ...
                <div class="grid grid-cols-1 gap-x-5 lg:grid-cols-2 2xl:grid-cols-3">
                    <div class="card">
                        <div class="card-body">
                            <h6 class="mb-4 text-15">@lang('locale.orders_report')</h6>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h6 class="mb-3 text-15">@lang('locale.payment_method')</h6>

                            <div class="flex flex-col gap-3">
                                <a href="pages-account.html#!" class="flex items-center gap-3 p-2 border rounded-md border-slate-200 dark:border-zink-500">
                                    <div class="flex items-center justify-center rounded-md size-12 shrink-0">
                                        <img src="{{ asset('images/img-013.png') }}" alt="" class="h-10">
                                    </div>
                                    <div class="grow">
                                ...
                                <a href="pages-account.html#!" class="flex items-center gap-3 p-2 border rounded-md border-slate-200 dark:border-zink-500">
                                    <div class="flex items-center justify-center rounded-md size-12 shrink-0">
                                        <img src="{{ asset('images/img-022.png') }}" alt="" class="h-10">
                                    </div>
                                    <div class="grow">
                                ...
                                <a href="pages-account.html#!" class="flex items-center gap-3 p-2 border rounded-md border-slate-200 dark:border-zink-500">
                                    <div class="flex items-center justify-center rounded-md size-12 shrink-0">
                                        <img src="{{ asset('images/img-032.png') }}" alt="" class="h-10">
                                    </div>
                                    <div class="grow">
                            ...
                            <tr class="bg-white dark:bg-zink-700">
                                ...
                                <td class="px-3.5 py-2.5 border-y border-transparent">
                                    <div class="flex items-center justify-end gap-2">
                                        <a href="pages-account.html#!" class="flex items-center justify-center transition-all duration-150 ease-linear rounded-md size-8 bg-slate-100 hover:bg-slate-200 dark:bg-zink-600 dark:hover:bg-zink-500"><i data-lucide="eye" class="size-3"></i></a>
                                        <a href="pages-account.html#!" class="flex items-center justify-center transition-all duration-150 ease-linear rounded-md size-8 bg-slate-100 hover:bg-slate-200 dark:bg-zink-600 dark:hover:bg-zink-500"><i data-lucide="file-edit" class="size-3"></i></a>
                                        <a href="pages-account.html#!" class="flex items-center justify-center transition-all duration-150 ease-linear rounded-md size-8 bg-slate-100 hover:bg-slate-200 dark:bg-zink-600 dark:hover:bg-zink-500"><i data-lucide="arrow-down-to-line" class="size-3"></i></a>
                                        <a href="pages-account.html#!" class="flex items-center justify-center transition-all duration-150 ease-linear rounded-md size-8 bg-slate-100 hover:bg-slate-200 dark:bg-zink-600 dark:hover:bg-zink-500"><i data-lucide="trash-2" class="size-3"></i></a>
                                    </div>
                                </td>
                            </tr>
                            <tr class="bg-white dark:bg-zink-700">
                ...
                <div class="grid grid-cols-1 gap-x-5 md:grid-cols-2 2xl:grid-cols-4">
                    <div class="card">
                        <div class="card-body">
                            <div class="flex">
                                <div class="grow">
                                    <img src="{{ asset('images/adwords.png') }}" alt="" class="h-11">
                                </div>
                                <div class="shrink-0">
                                    <div class="relative dropdown">
                                        ...
                                        <ul class="absolute z-50 hidden py-2 mt-1 text-left list-none bg-white rounded-md shadow-md dropdown-menu min-w-[10rem]" aria-labelledby="projectDropdownmenu1">
                                            <li>
                                                <a class="block px-4 py-1.5 text-base transition-all duration-200 ease-linear bg-white text-slate-600 dropdown-item hover:bg-slate-100 hover:text-slate-500 focus:bg-slate-100 focus:text-slate-500" href="pages-account.html#!"><i data-lucide="eye" class="inline-block mr-1 size-3"></i> Overview</a>
                                            </li>
                                            <li>
                                                <a class="block px-4 py-1.5 text-base transition-all duration-200 ease-linear bg-white text-slate-600 dropdown-item hover:bg-slate-100 hover:text-slate-500 focus:bg-slate-100 focus:text-slate-500" href="pages-account.html#!"><i data-lucide="file-edit" class="inline-block mr-1 size-3"></i> Edit</a>
                                            </li>
                                            <li>
                                                <a class="block px-4 py-1.5 text-base transition-all duration-200 ease-linear bg-white text-slate-600 dropdown-item hover:bg-slate-100 hover:text-slate-500 focus:bg-slate-100 focus:text-slate-500" href="pages-account.html#!"><i data-lucide="trash-2" class="inline-block mr-1 size-3"></i> Delete</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="mt-4">
                                <h6 class="mb-1 text-16"><a href="pages-account.html#!">Chat App</a></h6>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="flex">
                                <div class="grow">
                                    <img src="{{ asset('images/app-store.png') }}" alt="" class="h-11">
                                </div>
                                <div class="shrink-0">
                                    <div class="relative dropdown">
                            ...
                            <div class="mt-4">
                                <h6 class="mb-1 text-16"><a href="pages-account.html#!">Business Template - UI/UX design</a></h6>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mt-4">
                                <h6 class="mb-1 text-16"><a href="pages-account.html#!">ABC Project Customization</a></h6>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mt-4">
                                <h6 class="mb-1 text-16"><a href="pages-account.html#!">Tailwick Design</a></h6>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mt-4">
                                <h6 class="mb-1 text-16"><a href="pages-account.html#!">HR Management</a></h6>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="flex">
                                <div class="grow">
                                    <img src="{{ asset('images/meta.png') }}" alt="" class="h-11">
                                </div>
                                <div class="shrink-0">
                                    <div class="relative dropdown">
                            ...
                            <div class="mt-4">
                                <h6 class="mb-1 text-16"><a href="pages-account.html#!">Finance Apps</a></h6>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="flex">
                                <div class="grow">
                                    <img src="{{ asset('images/search.png') }}" alt="" class="h-11">
                                </div>
                                <div class="shrink-0">
                                    <div class="relative dropdown">
                            ...
                            <div class="mt-4">
                                <h6 class="mb-1 text-16"><a href="pages-account.html#!">Mailbox Design</a></h6>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mt-4">
                                <h6 class="mb-1 text-16"><a href="pages-account.html#!">Banking Management</a></h6>
                            ...
                            <div class="mt-4 text-center">
                                <div class="flex justify-center">
                                    <div class="overflow-hidden rounded-full size-20 bg-slate-100">
                                        <img src="{{ asset('images/avatar-3.png') }}" alt="" class="">
                                    </div>
                                </div>
                                <a href="pages-account.html#!"><h4 class="mt-4 mb-2 font-semibold text-16">Ralaphe Flores </h4></a>
                                <div class="text-slate-500 dark:text-zink-200">
                                    ...
                                    <h4 class="text-15 text-custom-500">Salary : $463.42 <span class="text-xs font-normal text-slate-500 dark:text-zink-200">/ Month<span></h4>
                                </div>
                            </div>
                        </div>
                    </div><!--end card-->
                    <div class="relative card">
                        <div class="card-body">
                            ...
                            <div class="mt-4 text-center">
                                <div class="flex justify-center">
                                    <div class="overflow-hidden rounded-full size-20 bg-slate-100">
                                        <img src="{{ asset('images/avatar-2.png') }}" alt="" class="">
                                    </div>
                                </div>
                                ...
                                <div class="text-slate-500 dark:text-zink-200">
                                    ...
                                    <h4 class="text-15 text-custom-500">Salary : $701.77 <span class="text-xs font-normal text-slate-500 dark:text-zink-200">/ Month<span></h4>
                                </div>
                            </div>
                        </div>
                    </div><!--end card-->
                    <div class="relative card">
                        <div class="card-body">
                            ...
                            <div class="mt-4 text-center">
                                <div class="flex justify-center">
                                    <div class="overflow-hidden rounded-full size-20 bg-slate-100">
                                        <img src="{{ asset('images/avatar-4.png') }}" alt="" class="">
                                    </div>
                                </div>
                                <a href="pages-account.html#!">
                                ...
                                <div class="text-slate-500 dark:text-zink-200">
                                    ...
                                    <h4 class="text-15 text-custom-500">Salary : $478.32 <span class="text-xs font-normal text-slate-500 dark:text-zink-200">/ Month<span></h4>
                                </div>
                            </div>
                        </div>
                    </div><!--end card-->
                    <div class="relative card">
                        <div class="card-body">
                            ...
                            <div class="mt-4 text-center">
                                <div class="flex justify-center">
                                    <div class="overflow-hidden rounded-full size-20 bg-slate-100">
                                        <img src="{{ asset('images/avatar-5.png') }}" alt="" class="">
                                    </div>
                                </div>
                                <a href="pages-account.html#!">
                                ...
                                <div class="text-slate-500 dark:text-zink-200">
                                    ...
                                    <h4 class="text-15 text-custom-500">Salary : $120.37 <span class="text-xs font-normal text-slate-500 dark:text-zink-200">/ Month<span></h4>
                                </div>
                            </div>
                        </div>
                    </div><!--end card-->
                    <div class="relative card">
                        <div class="card-body">
                            ...
                            <div class="mt-4 text-center">
                                <div class="flex justify-center">
                                    <div class="overflow-hidden rounded-full size-20 bg-slate-100">
                                        <img src="{{ asset('images/avatar-6.png') }}" alt="" class="">
                                    </div>
                                </div>
                                <a href="pages-account.html#!">
                                ...
                                <div class="text-slate-500 dark:text-zink-200">
                                    ...
                                    <h4 class="text-15 text-custom-500">Salary : $89.99 <span class="text-xs font-normal text-slate-500 dark:text-zink-200">/ Month<span></h4>
                                </div>
                            </div>
                        </div>
                    </div><!--end card-->
                    <div class="relative card">
                        <div class="card-body">
                            ...
                            <div class="mt-4 text-center">
                                <div class="flex justify-center">
                                    <div class="overflow-hidden rounded-full size-20 bg-slate-100">
                                        <img src="{{ asset('images/avatar-7.png') }}" alt="" class="">
                                    </div>
                                </div>
                                <a href="pages-account.html#!">
                                ...
                                <div class="text-slate-500 dark:text-zink-200">
                                    ...
                                    <h4 class="text-15 text-custom-500">Salary : $214.82 <span class="text-xs font-normal text-slate-500 dark:text-zink-200">/ Month<span></h4>
                                </div>
                            </div>
                        </div>
                    </div><!--end card-->
                    <div class="relative card">
                        <div class="card-body">
                            ...
                            <div class="mt-4 text-center">
                                <div class="flex justify-center">
                                    <div class="overflow-hidden rounded-full size-20 bg-slate-100">
                                        <img src="{{ asset('images/avatar-8.png') }}" alt="" class="">
                                    </div>
                                </div>
                                <a href="pages-account.html#!">
                                ...
                                <div class="text-slate-500 dark:text-zink-200">
                                    ...
                                    <h4 class="text-15 text-custom-500">Salary : $278.96 <span class="text-xs font-normal text-slate-500 dark:text-zink-200">/ Month<span></h4>
                                </div>
                            </div>
                        </div>
                    </div><!--end card-->
                    <div class="relative card">
                        <div class="card-body">
                            ...
                            <div class="mt-4 text-center">
                                <div class="flex justify-center">
                                    <div class="overflow-hidden rounded-full size-20 bg-slate-100">
                                        <img src="{{ asset('images/avatar-9.png') }}" alt="" class="">
                                    </div>
                                </div>
                                <a href="pages-account.html#!">
                                ...
                                <div class="text-slate-500 dark:text-zink-200">
                                    ...
                                    <h4 class="text-15 text-custom-500">Salary : $901.94 <span class="text-xs font-normal text-slate-500 dark:text-zink-200">/ Month<span></h4>
                                </div>
                            </div>
                        </div>
                    </div><!--end card-->
