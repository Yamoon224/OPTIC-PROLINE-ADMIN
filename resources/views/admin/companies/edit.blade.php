<x-app-layout :pagename="__('locale.edit_company')">
    <div class="card">
        <div class="border-b border-custom-200 flex items-center justify-between p-4">
            <h4 class="text-18">@lang('locale.edit_company')</h4>
        </div>
        ...
        <div class="card-body">
            <div class="overflow-x-auto w-full">
                <form action="{{ route('companies.update', $company->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <input type="hidden" name="_previous" value="{{ route('companies.index') }}">
                    <div class="flex flex-col h-full">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 px-6">
                            {{-- Company Name (Required) --}}
                            <div>
                                <label for="add_name" class="inline-block mb-2 text-base font-medium">
                                ...
                                <div class="relative">
                                    ...
                                    <input
                                        ...
                                        value="{{ $company->name }}"
                                        required
                                        class="ltr:pl-10 rtl:pr-10 form-input w-full ..."
                            ...
                            {{-- Register ID --}}
                            <div>
                                <label for="add_register_id" class="inline-block mb-2 text-base font-medium">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4 px-6">
                            {{-- Address (Required) --}}
                            <div>
                                <label for="add_address" class="inline-block mb-2 text-base font-medium">
                            ...
                            {{-- Contact (Required) --}}
                            <div>
                                <label for="add_contact" class="inline-block mb-2 text-base font-medium">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="flex items-center justify-center border rounded-md cursor-pointer bg-slate-100 dropzone border-slate-200 dark:bg-zink-600 dark:border-zink-500">
                                        <div class="fallback">
                                            <input name="logo" type="file" accept=".jpeg, .png, .jpg, .gif, .svg, .webp" multiple="multiple">
                                        </div>
