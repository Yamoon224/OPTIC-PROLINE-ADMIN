<footer class="relative pt-20 pb-12 border-t border-slate-200 dark:border-zinc-800">
        ...
        <div class="relative z-10 grid grid-cols-12 gap-5 xl:grid-cols-12">
            <div class="col-span-12 md:col-span-12 lg:col-span-12 xl:col-span-4">
                ...
                <ul class="flex items-center gap-3">
                    <li>
                        <a href="product-landing.html#!" class="flex items-center justify-center transition-all duration-200 ease-linear border rounded-full size-10 text-slate-500 border-slate-200 dark:text-zinc-400 dark:border-zinc-800 hover:text-custom-500 dark:hover:text-custom-500"><i data-lucide="facebook" class="size-4"></i></a>
                    </li>
                    <li>
                        <a href="product-landing.html#!" class="flex items-center justify-center transition-all duration-200 ease-linear border rounded-full size-10 text-slate-500 border-slate-200 dark:text-zinc-400 dark:border-zinc-800 hover:text-custom-500 dark:hover:text-custom-500"><i data-lucide="linkedin" class="size-4"></i></a>
                    </li>
                    <li>
                        <a href="product-landing.html#!" class="flex items-center justify-center transition-all duration-200 ease-linear border rounded-full size-10 text-slate-500 border-slate-200 dark:text-zinc-400 dark:border-zinc-800 hover:text-custom-500 dark:hover:text-custom-500"><i data-lucide="instagram" class="size-4"></i></a>
                    </li>
                    <li>
                        <a href="product-landing.html#!" class="flex items-center justify-center transition-all duration-200 ease-linear border rounded-full size-10 text-slate-500 border-slate-200 dark:text-zinc-400 dark:border-zinc-800 hover:text-custom-500 dark:hover:text-custom-500"><i data-lucide="twitter" class="size-4"></i></a>
                    </li>
                    <li>
                        <a href="product-landing.html#!" class="flex items-center justify-center transition-all duration-200 ease-linear border rounded-full size-10 text-slate-500 border-slate-200 dark:text-zinc-400 dark:border-zinc-800 hover:text-custom-500 dark:hover:text-custom-500"><i data-lucide="youtube" class="size-4"></i></a>
                    </li>
                </ul>
            </div>
    ...
    <div class="pt-10 mt-16 text-center border-t text-slate-500 dark:text-zinc-400 dark:border-zinc-800 text-16">
        <p>
            <script>document.write(new Date().getFullYear())</script> © OPTIC PROLINE. Design & Develop by <a href="product-landing.html#!" class="underline text-slate-800 dark:text-zinc-100">EDITOSYSTEM</a>
        </p>
    </div>
</footer>